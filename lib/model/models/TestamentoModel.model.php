<?php
class TestamentoModel extends ActiveModel {
	protected static $ActiveObject = "Testamento";
	public static $TABLE = "biblia_testamento";
	protected static $fields = array("testamentoid", "nome", "informacao");
