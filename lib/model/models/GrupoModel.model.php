<?php
class GrupoModel extends ActiveModel {
	protected static $ActiveObject = "Grupo";
	public static $TABLE = "w11_grupo";
	protected static $fields = array("GRP_ID", "GRP_TIT", "GRP_DES", "GRP_STS");
