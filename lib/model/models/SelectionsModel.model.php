<?php
class SelectionsModel extends ActiveModel {
	protected static $ActiveObject = "Selections";
	public static $TABLE = "cnt_team";
	protected static $fields = array("id", "name", "initial_pos", "points", "group", "status");
