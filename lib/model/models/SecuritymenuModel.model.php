<?php
class SecuritymenuModel extends ActiveModel {
	protected static $ActiveObject = "Securitymenu";
	public static $TABLE = "w11_produto_menu_grupo";
	protected static $fields = array("MSC_ID", "MSC_IGR", "MSC_IMN");
