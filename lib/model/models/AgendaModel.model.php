<?php
class AgendaModel extends ActiveModel {
	protected static $ActiveObject = "Agenda";
	public static $TABLE = "cnt_conteudo";
	protected static $fields = array("CNT_ID", "CNT_SIT", "CNT_IPR", "CNT_TIP", "CNT_DTA", "CNT_TIS", "CNT_TIT", "CNT_OLH", "CNT_TXT", "CNT_RES", "CNT_FT1", "CNT_FT1_", "CNT_RDT", "CNT_EMA", "CNT_CHV", "CNT_CMT", "CNT_DTF", "CNT_CMD", "CNT_CKY", "CNT_TAG", "CNT_CAT", "CNT_ENQ", "CNT_CTT", "CNT_PAI", "CNT_EST", "CNT_STS", "CNT_LOC");
