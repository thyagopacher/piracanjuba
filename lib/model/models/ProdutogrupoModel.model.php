<?php
class ProdutogrupoModel extends ActiveModel {
	protected static $ActiveObject = "Produtogrupo";
	public static $TABLE = "w11_produto_grupo";
	protected $FID = "SEC_ID";
	protected static $fields = array("SEC_ID", "SEC_IGR", "SEC_IPR");
