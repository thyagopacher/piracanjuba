<?php
class CapitulosModel extends ActiveModel {
	protected static $ActiveObject = "Capitulos";
	public static $TABLE = "biblia_livro";
	protected static $fields = array("livroid", "sigla", "nome", "informacao", "testamentoid", "categoriaid");
