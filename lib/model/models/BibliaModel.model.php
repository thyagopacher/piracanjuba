<?php
class BibliaModel extends ActiveModel {
	protected static $ActiveObject = "Biblia";
	public static $TABLE = "biblia_texto";
	protected static $fields = array("textoid", "titulo", "subtitulo", "capitulo", "versiculo", "texto", "referencias", "isjesus", "livroid");
