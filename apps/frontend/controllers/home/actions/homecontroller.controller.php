...
class HomeController extends DefaultController
{
    ...
    public function contato($vars = null)
    {
        ...
        $criteria = new FuriousSelectCriteria();
        $criteria->add("`cnt_destaques`.`DTQ_EDT`", 4, FuriousExpressionsDB::EQUAL);
    ...
    public function faq($vars){
        ...
        $criteria = new FuriousSelectCriteria();
        $criteria->add("`cnt_destaques`.`DTQ_EDT`", 8, FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_TIP`", "bg", FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_STS`", 1, FuriousExpressionsDB::EQUAL);
    ...
    public function releases($vars = null)
    {
        ...
        $criteria = new FuriousSelectCriteria();
        $criteria->add("`cnt_destaques`.`DTQ_EDT`", 21, FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_TIP`", "bg", FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_STS`", 1, FuriousExpressionsDB::EQUAL);
    ...
    public function piracanjubaNaMidia($vars = null)
    {
        ...
        $criteria = new FuriousSelectCriteria();
        $criteria->add("`cnt_destaques`.`DTQ_EDT`", 22, FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_TIP`", "bg", FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_STS`", 1, FuriousExpressionsDB::EQUAL);
    ...
    public function lei12669($vars = null){
        ...
        $criteria = new FuriousSelectCriteria();
        $criteria->add("`cnt_destaques`.`DTQ_EDT`", 3, FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_TIP`", "bg", FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_STS`", 1, FuriousExpressionsDB::EQUAL);
    ...
    public function ondeEncontrar($vars)
    {
        ...
        $criteria = new FuriousSelectCriteria();
        $criteria->add("`cnt_destaques`.`DTQ_EDT`", 19, FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_TIP`", "bg", FuriousExpressionsDB::EQUAL);
        $criteria->add("`cnt_destaques`.`DTQ_STS`", 1, FuriousExpressionsDB::EQUAL);
    ...
    public function qualidadeDoLeite($vars = null){
        ...
        if(!empty($conteudo[0])){
            ...
            $criteria = new FuriousSelectCriteria();
            $criteria->add("`cnt_destaques`.`DTQ_EDT`", 16, FuriousExpressionsDB::EQUAL);
            $criteria->add("`cnt_destaques`.`DTQ_TIP`", "bg", FuriousExpressionsDB::EQUAL);
            $criteria->add("`cnt_destaques`.`DTQ_STS`", 1, FuriousExpressionsDB::EQUAL);
