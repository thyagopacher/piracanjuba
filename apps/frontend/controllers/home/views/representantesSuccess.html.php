...
<section id="insideContent">
    <div class="alignContent">
        <div class="releaseSearch">
            <form action="/representantes#insideContent" method="get">
                ...
                <ul>
                  ...
                  <?php foreach($this->releases as $release){
                    ...
                    <li>
                        ...
                        <p><?php echo($release->getCNTRDT()); ?></p>
                        <a href="" class="arrow-right openClose"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
                        <div class="fullText">
                          <p>
                            <?php echo($release->getCNTOLH()); ?><br />
                            <?php echo($release->getCNTRES()); ?><br />
                            <?php echo($release->getCNTEMB()); ?><br />
                          </p>
                          <?php echo($release->getCNTTXT()); ?>
                        </div>
                    </li>
                  <?php } ?>
                  <?php } else { ?>
