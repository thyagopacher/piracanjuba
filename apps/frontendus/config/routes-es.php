...
Dispatcher::addRoutes("/{$appPrefix}piracanjuba-pro-campo(\/)?/i", "home", "equipeDeCompraLeite", "html", true, true, array("ID" => "2300"));
...
Dispatcher::addRoutes("/{$appPrefix}produtor-de-leite\/politica-leiteira$/i", "home", "qualidadeDoLeite", "html", true, true, array("ID" => "2737"));
...
Dispatcher::addRoutes("/{$appPrefix}equipe-de-compra-de-leite(\/)?/i", "home", "equipeDeCompraLeite", "html", true, true, array("ID" => "2286"));
