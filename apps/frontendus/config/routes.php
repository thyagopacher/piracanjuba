...
Dispatcher::addRoutes("/{$appPrefix}lista-cidades/i", "home", "listaCidades", "html", true, true);
//Dispatcher::addRoutes("/{$appPrefix}listaCidades(.+)-([0-9]+)/i", "home", "listaCidades", "html", true, true, array("ID" => ":1"));
...
Dispatcher::addRoutes("/{$appPrefix}piracanjuba-pro-campo(\/)?/i", "home", "equipeDeCompraLeite", "html", true, true, array("ID" => "1300"));
...
Dispatcher::addRoutes("/{$appPrefix}produtor-de-leite\/politica-leiteira$/i", "home", "qualidadeDoLeite", "html", true, true, array("ID" => "1737"));
...
Dispatcher::addRoutes("/{$appPrefix}equipe-de-compra-de-leite(\/)?/i", "home", "equipeDeCompraLeite", "html", true, true, array("ID" => "1286"));
