...
<header id="insideHeader">
    <div class="insideWaves">
        <div class="insideTop">
            ...
            <p class="breadCrumb"><strong>{YOU_ARE_HERE}:</strong>  <a href="#">{Pagina_Principal}</a> / <a href="<?php echo($this->site->PDT_URL); ?>produtos">{Produtos}</a> / <a href="#">Pirakids</a></p>
        </div>
    </div>
                ...
                <li>
                    <div class="description">
                        <div class="faq">
                            ...
                            <a href="<?php echo($this->site->PDT_URL); ?>faq" class="button faq">FAQ</a>
                        </div>
                        <div class="product">
    ...
    <div class="custom-bg">
        ...
        <div class="see-also">
            <div class="alignContent">
                <div class="text">
                    <div>
                        <p>{Piradinho nasceu numa família comum e desde cedo se mostrava muito curioso e disposto a aprender coisas novas, a entender como as coisas funcionam.}</p>
