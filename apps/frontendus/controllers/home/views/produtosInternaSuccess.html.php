<header id="insideHeader">
	<div class="insideWaves">
		<div class="insideTop">
			...
			<p class="breadCrumb"><strong>{YOU_ARE_HERE}:</strong>  <a href="<?php echo($this->site->PDT_URL); ?>">{Pagina_Principal}</a> / <a href="<?php echo($this->site->PDT_URL); ?>produtos">{Produtos}</a> / <a href="#"><?=$this->categoria->CAT_NOM?></a></p>
		</div>
	</div>
	<?php
	$bg = "";
	...
	<div class="showImage" style="background-image: url(<?= $bg;?>); " >
		<div class="productSlide">
			...
			<ul>
				<li>
					<a href=""><img src="<?=(!empty($fto))?$fto->getFile()->getFormat("250x380"):""?>" /></a>
		...
		<div class="alignContent">
			<div class="boxSettings">
				<nav>
					...
					<a href="<?php echo($this->site->PDT_URL); ?>produtos-impressao/<?=Slugfy2($this->produto->CNT_TIT)."-".$this->produto->CNT_ID?>" class="print" target="_blank"></a>
				</nav>
				<div class="shareNote">
					<p>{Compartilhe}</p>
					<nav>
