					...
					<div class="post-perguntas">
							...
							<div class="tag-author">
								...
								<div class="segura-tags">
									...
									<a href="<?php echo($this->site->PDT_URL); ?><?php echo(APP_LANGUAGE); ?>/forum/tags/<?php echo(($tag->getTAGID())."-".(Slugfy(($tag->getTAGNOM())))); ?>" class="btP"><?php echo(utf8_decode($tag->getTAGNOM()))?></a>
									<?php endforeach; ?>
								</div>
								<?php endif; ?>
							</div>
