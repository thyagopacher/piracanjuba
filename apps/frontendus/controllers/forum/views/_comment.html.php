...
<ul class="posts">
	...
	<li>
		...
		<div class="votos">
			<a href="<?php echo($this->site->PDT_URL); ?><?php echo(APP_LANGUAGE); ?>/comment/<?php echo($coment['MSG_ID']); ?>/like" class="voto-up" rel=".votos h2">Up</a>
			<br/>
			<h2><?php echo(htmlspecialchars(utf8_decode($coment['MSG_NOT']))); ?></h2>
			<br/>
			<a href="<?php echo($this->site->PDT_URL); ?><?php echo(APP_LANGUAGE); ?>/comment/<?php echo($coment['MSG_ID']); ?>/unlike" class="voto-down" rel=".votos h2">Down</a>
		</div>
