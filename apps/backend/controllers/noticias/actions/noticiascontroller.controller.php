<?php
	class NoticiasController extends DefaultBackEnd2Controller
	{
		...
		public function index($vars = null)
		{
			...
			$this->breadCrumb = array("noticias/index.php" => "{News}");
		...
		public function novo($vars = null)
		{
			...
			if($newsID != null)
			{
				$this->breadCrumb["noticias/new.php"] = "{Edit News}";
			...
			$this->action = $this->Editorial->getURL()."noticias/edit.php?ID=".($this->content->getCNTID());
