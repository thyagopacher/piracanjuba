...
<div id="internal-page">
	...
	<h1 class="icnPage newPage"><a href="<?php echo($this->Editorial->getURL()); ?>estabelecimentos/new.php">Adicionar Estabelecimento</a></h1>
					...
					<table class="listTable hasQuickForm">
						...
						<tbody>
							...
							<tr class="odd">
								...
								<td class="leftTxt">
									<a href="<?php echo($this->Editorial->getURL()); ?>estabelecimentos/edit.php?ID=<?php echo($item->getCNTID()); ?>"><?php echo(date("d/m/Y H:i", strtotime($item->getCNTDTA()))); ?></a>
								</td>
								<td class="leftTxt">
									<a href="<?php echo($this->Editorial->getURL()); ?>estabelecimentos/edit.php?ID=<?php echo($item->getCNTID()); ?>"><?php echo($item->getCNTTIT()); ?></a>
								</td>
								<td class="leftTxt">
									<a href="<?php echo($this->Editorial->getURL()); ?>estabelecimentos/edit.php?ID=<?php echo($item->getCNTID()); ?>"><?php echo($item->getCNTOLH()); ?></a>
								</td>
								<td class="leftTxt">
									<a href="<?php echo($this->Editorial->getURL()); ?>estabelecimentos/edit.php?ID=<?php echo($item->getCNTID()); ?>"><?php echo($item->getCNTRDT()); ?></a>
								</td>
								<?php
								...
								<td>
									<a href="<?php echo($this->Editorial->getURL()); ?>estabelecimentos/edit.php?ID=<?php echo($item->getCNTID()); ?>" rel="Editar" title="Editar" class="btnsAdmin">Editar</a>

									<a href="<?php echo($this->Editorial->getURL()); ?>estabelecimentos/delete.php?ID=<?php echo($item->getCNTID()); ?>" rel="Remover" title="Deletar" class="btnsAdmin">Deletar</a>
