<?php
	class NewsController extends DefaultBackEnd2Controller
	{
		...
		public function index($vars = null)
		{
			...
			$this->breadCrumb = array("news/index.php" => "{News}");
		...
		public function novo($vars = null)
		{
			...
			if($newsID != null)
			{
				$this->breadCrumb["news/new.php"] = "{Edit News}";
				...
				$this->breadCrumb["news/new.php"] = "{Add News}";
			...
			$this->action = $this->Editorial->getURL()."news/edit.php?ID=".($this->content->getCNTID());
		}
