...
-->
						...
						<label for="cnt_txt">Descricao</label>
						...
						<label for="cnt_emb">Referencias Bibliograficas</label>
			...
			<div class="col-2">
                ...
                <?php $this->insertBlock("dicasnutricao", "produtoBox", array("CONTAINER" => "news", "CONTENT" => $this->content)); ?>

				<?php $this->insertBlock("dicasnutricao", "categoriaBox", array("CONTAINER" => "news", "CONTENT" => $this->content)); ?>
