			...
			<div class="col-1">
				...
				<div class="box">
					...
					<div>
						...
						?>
						<p><a href="<?php printf("%s{testemunhos_url}/%s/%s.html", $this->Site->getPDTURL(), date("Y/m/d", strtotime($dta)), $url); ?>" class="linkSite" target="_blank">
						<?php printf("%s{testemunhos_url}/%s/%s.html", $this->Site->getPDTURL(), date("Y/m/d", strtotime($dta)), $url); ?>
						</a></p>
