...
<div id="internal-page">
	...
	<form id="newsForm" method="post" action="<?php echo($this->action);?>">
		...
		<div class="two-cols LeftExpanded">
			...
			<div class="col-2">
				<?php
				$this->insertBlock("home", "publishBox", array("CONTAINER" => "news", "CONTENT" => $this->content, "STATUS_FIELD" => "CNT_STS"));
				$this->insertBlock("home", "editorialsBox", array("CONTAINER" => "news", "CONTENT" => $this->content, "CATEGORY_TYPE" => $this->editorialTaxonomy));
				$this->insertBlock("home", "imageBox", array("CONTAINER" => "news", "CONTENT" => $this->content, "THUMB_TYPE" => "THB_CNT"));
				//$this->insertBlock("home", "imageBox", array("CONTAINER" => "news", "CONTENT" => $this->content, "THUMB_TYPE" => "THB_EMB1", "TITLE"=> "Imagem Embed1", "FIELD_NAME" => "IMG_DTQ2"));
				//$this->insertBlock("home", "tagsBox", array("CONTAINER" => "news", "CONTENT" => $this->content));
				//$this->insertBlock("home", "relcontentBox", array("CONTAINER" => "news", "CONTENT" => $this->content));
				?>
