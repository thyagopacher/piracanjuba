						...
						<tbody>
							...
							<tr class="odd">
								...
								<td>
									...
									<a href="<?php echo($this->Editorial->getURL()); ?>news/edit.php?ID=<?php echo($item->getCNTID()); ?>" rel="Edicao Rapida" title="Edição Rápida" class="btnsAdmin quickEditBtn">Editar</a>
								</td>
							</tr>
