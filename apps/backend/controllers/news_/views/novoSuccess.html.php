			...
			<div class="col-1">
				...
				<div class="box">
					...
					<div>
						...
						<p><a href="<?php printf("%spreview/{news_url}/%s/%s.html", $this->Site->getPDTURL(), date("Y/m/d", strtotime($dta)), $url); ?>" class="bot" id="previewBot" target="_blank">{preview}</a></p>

						<!-- /LinkSite -->
						<?php } ?>

						<label for="cnt_olh" class="hidden">{Intro}</label>
						<input type="text" name="news[CNT_OLH]" id="cnt_olh" class="inputText" placeholder="Linha fina" maxlength="180" value="<?php echo($this->content->getCNTOLH()); ?>"/><br />
