	...
	<form id="newsForm" method="post" action="<?php echo($this->action);?>">
		...
		<div class="two-cols LeftExpanded">
			...
			<div class="col-1">
				...
				<!-- /Conteudo -->
				<?php $this->insertBlock("home", "linksBox", array("CONTAINER" => "news", "CONTENT" => $this->content, 'BOX_TITLE' => 'Perguntas e Respostas', 'LABELS' => array('TITLE' => 'Título', 'LINK' => 'Texto', 'ADD_BUTTON' => 'Adicionar Pergunta e Resposta', 'REMOVE_BUTTON' => 'Remover Pergunta e Resposta'))); ?>
