	...
	<form id="newsForm" method="post" action="<?php echo($this->action);?>">
		...
		<div class="two-cols LeftExpanded">
			...
			<div class="col-1">
				...
				<div class="box">
					...
					<div>
						...
						<label for="cnt_olh" class="hidden">Nome do representante</label>
						<input type="text" name="news[CNT_OLH]" id="cnt_olh" class="inputText" placeholder="Nome do representante" maxlength="180" value="<?php echo($this->content->getCNTOLH()); ?>"/><br />
			...
			<div class="col-2">
				...
				<?php $this->insertBlock("representantes", "estadoBox", array("CONTAINER" => "news", "CONTENT" => $this->content, "STATUS_FIELD" => "CNT_STS")); ?>
