			...
			<div class="col-1">
				...
				<div class="box">
					...
					<div>
						...
						?>
						<p><a href="<?php printf("%s{videos_url}/%s/%s.html", $this->Site->getPDTURL(), date("Y/m/d", strtotime($dta)), $url); ?>" class="linkSite" target="_blank">
						<?php printf("%s{videos_url}/%s/%s.html", $this->Site->getPDTURL(), date("Y/m/d", strtotime($dta)), $url); ?>
						</a></p>
						...
						<p><a href="<?php printf("%spreview/{videos_url}/%s/%s.html", $this->Site->getPDTURL(), date("Y/m/d", strtotime($dta)), $url); ?>" class="bot" id="previewBot" target="_blank">{preview}</a></p>

						<!-- /LinkSite -->
						<?php } ?>

						<label for="cnt_olh" class="hidden">{Intro}</label>
						<input type="text" name="news[CNT_OLH]" id="cnt_olh" class="inputText" placeholder="Linha Fina" value="<?php echo($this->content->getCNTOLH()); ?>"/><br />
						...
						<label for="cnt_emb" class="no-points"><strong>Embed</strong></label><br />
